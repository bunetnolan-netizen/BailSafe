# ⚠️ ARCHIVÉ / DÉPRÉCIÉ — remplacé par index.html (vitrine standalone à déployer sur Netlify).
# Conservé ici pour référence uniquement. Ne pas utiliser pour de nouveaux déploiements :
# contient encore l'ancien lien de paiement Stripe en mode test et le CTA LeBonCoin.
# Voir BAILSAFE_CONTEXTE.md pour le détail de la migration.
            ...
            <div class="offer-body">
                ...
                <div id="form-section">
                    <div class="form-box">
                        ...
                        <div class="form-box-sub">Remplissez vos infos — vous recevrez une confirmation par email</div>
    ...
    <script>
        ...
        async function handleSubmit() {{
            ...
            try {{
                ...
                showToast('❌ Erreur : ' + err.message + '. Contacte bunetnolan@gmail.com directement.', true);
            }}
        }}
    </script>
